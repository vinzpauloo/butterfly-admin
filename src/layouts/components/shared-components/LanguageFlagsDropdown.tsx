...
const LanguageFlagsDropdown = () => {
    ...
    return (
        <>
            ...
            <LanguageMenu className='language-menu' keepMounted id='language-menu' anchorEl={anchorEl} onClose={handleClose} open={Boolean(anchorEl)}>
                <Typography marginBottom={2} fontWeight={700} variant='body1' fontFamily={theme.customTypography.fontFamilyPoppins} color='white'>Language</Typography>
