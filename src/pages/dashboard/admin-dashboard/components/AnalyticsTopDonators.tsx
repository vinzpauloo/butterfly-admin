...
const AnalyticsTopDonators = () => {
  ...
  return (
    <Card sx={{ display: 'flex', justifyContent: 'space-between', flexDirection: ['column', 'column', 'row'] }}>
      <Box sx={{ width: '100%', overflowY: 'auto', height: '410px' }}>
        <CardHeader
          title='Top Donators'
          ...
          action={
            <Button
              ...
              onClick={() => router.push(`/user/list/Customers`)}
            >
              View Users
            </Button>
          }
              ...
              return (
                <Box key={index} sx={{ display: 'flex', alignItems: 'center', mb: 4 }}>
                  <Box sx={{ minWidth: 38, display: 'flex', justifyContent: 'center' }}>
                    <img src={FILE_SERVER_URL + item.photo} alt={item.title} width={30} height={30} />
                  </Box>
                  <Box
                    sx={{
                      ml: 4,
                  ...
                  >
                    <Box sx={{ mr: 2, display: 'flex', flexDirection: 'column' }}>
                      <Typography sx={{ fontWeight: 600, fontSize: '0.875rem' }}>{item.username}</Typography>
                      <Typography variant='caption'>{item.mobile}</Typography>
                    </Box>
...
export default AnalyticsTopDonators
