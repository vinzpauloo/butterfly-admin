...
function createOperatorData(
  ...
  return { id, userProfile, mobileNumber: formattedMobileNumber, email, dateCreated: formattedDateCreated, lastLogIn: formattedLastLog};
}
...
const operatorRows = [
  ...
  // {...createOperatorData(10,'Wang Fei', +639176543210, `my@account.com`, 1641811602000, 1643620222000)},
  // {...createOperatorData(11,'Chun Lee', +639176543210, `my@account.com`, 1641811602000, 1643620222000)},
  // {...createOperatorData(12,'Fei Long', +639176543210, `my@account.com`, 1641811602000, 1643620222000)},
  // {...createOperatorData(13,'Jackie Chan', +639176543210, `my@account.com`, 1644326766000, 1643620222000)},
  // {...createOperatorData(14,'Pai Long', +639176543210, `my@account.com`, 1644326766000, 1643620222000)},
];
